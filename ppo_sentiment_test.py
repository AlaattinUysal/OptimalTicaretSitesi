# ppo_sentiment_test.py dosyasının en başına eklenecek kod
import matplotlib
matplotlib.use('Agg') # Grafik motorunu değiştirir
...
# --- TEST PARAMETRELERİ ---
# --- DEĞİŞİKLİK: Doğru model dosyasını hedefliyoruz ---
MODEL_DOSYASI = "ppo_sentiment_model.zip" 
HİSSE_KODU = "THYAO.IS"
...
# veri_cek_ve_hazirla artık duygu verisini de otomatik olarak birleştirecek
...
# Duygu analizi verisini de içeren 6 özellikli ortamı kuruyoruz
...
print("\n--- PPO (DUYGU ANALİZİ) TEST SONUÇLARI ---")
...
if ppo_getiri > al_ve_tut_getiri:
    print("\nSonuç: PPO (Duygu Analizi) ajanı, 'Al ve Tut' stratejisinden daha iyi performans gösterdi. ✅")
else:
    print("\nSonuç: PPO (Duygu Analizi) ajanı, 'Al ve Tut' stratejisini geçemedi. ❌")
...
plt.title('PPO Ajanının (Duygu Analizi) Test Verisi Üzerindeki Alım-Satım Noktaları')
plt.xlabel('Tarih')
